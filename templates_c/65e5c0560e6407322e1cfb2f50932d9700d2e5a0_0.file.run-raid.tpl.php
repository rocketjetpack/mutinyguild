<?php
/* Smarty version 4.0.0, created on 2022-01-27 21:47:32
  from '/home/dh_m6zq7r/mutiny-guild.com/templates/run-raid.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.0.0',
  'unifunc' => 'content_61f35944d5fce6_22844243',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '65e5c0560e6407322e1cfb2f50932d9700d2e5a0' => 
    array (
      0 => '/home/dh_m6zq7r/mutiny-guild.com/templates/run-raid.tpl',
      1 => 1643338049,
      2 => 'file',
    ),
  ),
...
function content_61f35944d5fce6_22844243 (Smarty_Internal_Template $_smarty_tpl) {
?><div style="padding-top: 60px;">
    <div class="row about-title">
		<?php if ($_smarty_tpl->tpl_vars['resumedRaid']->value) {?>
		...
		<div class="col" text-left">
			<form action="index.php" method="post">
				<input type="hidden" name="listid" value="<?php echo $_smarty_tpl->tpl_vars['listid']->value;?>
" />
				<input type="hidden" name="raidid" value="<?php echo $_smarty_tpl->tpl_vars['raidid']->value;?>
" />
	...
	<div class="row about-section">
		...
		<div class="col-md-4">
			...
			<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['raid_list_details']->value, 'raid_member');
$_smarty_tpl->tpl_vars['raid_member']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['raid_member']->value) {
$_smarty_tpl->tpl_vars['raid_member']->do_else = false;
?>
	<div class="row about-section" style="width: 90%;"><div id="player_<?php echo $_smarty_tpl->tpl_vars['raid_member']->value['username'];?>
" class="col text-center border" style="padding: 5px; margin-left: 25px; cursor: pointer;" onClick="selectPlayerByDiv(this);"><?php echo $_smarty_tpl->tpl_vars['raid_member']->value['pos'];?>
 - <?php echo $_smarty_tpl->tpl_vars['raid_member']->value['username'];?>
</div></div>		<?php
}
...
<div id="lootConfirmModal" class="modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	  ...
	  <div id="lootConfirmModalList" class="modal-body" style="display: none;"><?php echo $_smarty_tpl->tpl_vars['listid']->value;?>
</div>
	  <div id="lootConfirmModalRaid" class="modal-body" style="display: none;"><?php echo $_smarty_tpl->tpl_vars['raidid']->value;?>
</div>
